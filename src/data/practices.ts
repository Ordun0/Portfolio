...
export const practices: Practice[] = [
  ...
  { number: 8, title: "Práctica 7", description: "Mega-constelaciones de satélites: conectividad global y el costo de un cielo saturado .", pdf: "/Practica7.pdf" },
  { number: 9, title: "Práctica 8", description: "Ensayo sobre Nearshoring.", pdf: "/Practica8.pdf" },
